...
namespace Barebones.MasterServer
{
    ...
    public class AuthUiController : MonoBehaviour
    {
        ...
        public List<GameObject> EnableObjectsOnLogout;
        ...
        private void OnLoggedIn()
        {
            ...
            //Desactivamos las opciones de poner ip y conectarse
        ...
        protected virtual void OnLoggedOut()
        {
            ...
            //Activamos objetos para poner ip y conectarse
            foreach (var obj in EnableObjectsOnLogout)
            {
                if (obj != null)
                    obj.SetActive(true);
            }
